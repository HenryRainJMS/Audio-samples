function [W]=nmf_training(Rank,Spec,beta,iter_num)
%% NMF
%´¿¾»ÓïÒôÑµÁ·%ÔëÉùÑµÁ·
...
%%
% [Ws,Hs]=nmf_beta(Mag.speech,Rank.speech,'beta',beta,'niter',iter_num);
% [Wn,Hn]=nmf_beta(Mag.noise,Rank.noise,'beta',beta,'niter',iter_num);
%%ÓïÒôºÍÔëÉùÁªºÏ¾ØÕó
W=[Ws Wn];